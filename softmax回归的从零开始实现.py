...
def train_epoch_ch3(net,train_iter,loss,updater):#训练模型一个迭代周期；将模型设置为训练模式
    if isinstance(net,torch.nn.Module):
        net.train()#训练损失总和、训练精准度总和，样本数
...
def train_ch3(net,train_iter,test_iter,loss,num_epochs,updater):
    ...
    assert test_acc <= 1 and test_acc
lr = 0.1
